...
///
/// Это не список матчей с фильтром — тот живёт в расписании и на странице турнира.
/// Здесь нужен короткий срез витрины, поэтому ни фильтра, ни сортировки у запроса нет: их нечем было бы выразить в ссылке, а значит им здесь не место
