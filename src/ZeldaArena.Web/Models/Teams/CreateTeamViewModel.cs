...
/// <summary>
/// Форма создания команды — клиентский уровень двухуровневой валидации (docs/SPEC.md §15).
/// Длины и шаблоны взяты из <see cref="EsportsValidationRules"/>, тех же, что читает
/// FluentValidation-валидатор команды: два уровня проверяют одно и то же.
/// </summary>
